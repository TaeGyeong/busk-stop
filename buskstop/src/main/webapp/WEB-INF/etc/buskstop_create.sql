...
CREATE TABLE PREMIUM_STAGE (
	...
	PREMIUM_STAGE_NAME VARCHAR2(50) NOT NULL, /* 장소명 */
	PREMIUM_STAGE_LOCATION VARCHAR2(80) NOT NULL, /* 주소 */
	PREMIUM_STAGE_AREA NUMBER(5) NOT NULL, /* 면적 */
	PREMIUM_STAGE_COST NUMBER(7) NOT NULL, /* 가격 */
	PREMIUM_STAGE_INSTRUMENT VARCHAR2(100),
	PREMIUM_STAGE_CONTENT VARCHAR2(3000),
	PREMIUM_STAGE_PARKING NUMBER(1),
	PREMIUM_STAGE_DRINKING NUMBER(1),
	PREMIUM_STAGE_FOOD_SELL NUMBER(1),
	PREMIUM_STAGE_FOOD_RESTRICTION NUMBER(1),
	PREMIUM_STAGE_IMAGE VARCHAR2(50), /* 사진 */
...
CREATE TABLE STAGE (
	...
	STAGE_RESERVATION NUMBER(1) NOT NULL, /* 예약가능여부 */
...
/*------------------------------------------------------------------------------------*/
	...
	CREATE TABLE STAGE_RESERVATION_TIME(
		...
		CONSTRAINT FK_STAGE_TO_STAGE_RESERVATION_TIME
		FOREIGN KEY (STAGE_NO)REFERENCES MY_SCHEMA.STAGE (STAGE_NO);
...
/*------------------------------------------------------------------------------------*/
	...
	CONSTRAINT PK_PREMIUM_STAGE_RESERVATION	PRIMARY KEY (ESTABLISH_NO);
	CONSTRAINT FK_STAGE_SUPPLIER_TO_PREMIUM_STAGE_RESERVATION
		FOREIGN KEY (ESTABLISH_NO) REFERENCES STAGE_SUPPLIER (ESTABLISH_NO);
		
	CONSTRAINT FK_USERS_TO_PREMIUM_STAGE_RESERVATION
...
/*------------------------------------------------------------------------------------*/
	...
	/* 프리미엄 공급장 예약 시간코드 */
	CREATE TABLE MY_SCHEMA.PREMIUM_STAGE_RESERVATION_TIME (
	TIME_CODE NUMBER(2) NOT NULL, /* 시간코드 */
	STAGE_RENTAL_DATE DATE NOT NULL, /* 대관가능 날짜 */
	ESTABLISH_NO NUMBER(10) NOT NULL /* 사업장 번호 */
	
	CONSTRAINT PK_PREMIUM_STAGE_RESERVATION_TIME
		PRIMARY KEY (TIME_CODE,STAGE_RENTAL_DATE);
		
	CONSTRAINT FK_PREMIUM_STAGE_RESERVATION_TO_PREMIUM_STAGE_RESERVATION_TIME
		FOREIGN KEY (ESTABLISH_NO)	REFERENCES MY_SCHEMA.PREMIUM_STAGE_RESERVATION (ESTABLISH_NO);	
	);
...
/*------------------------------------------------------------------------------------*/	
	...
	CREATE TABLE MY_SCHEMA.PREMIUM_STAGE_IMAGE (
	...
	CONSTRAINT FK_STAGE_SUPPLIER_TO_PREMIUM_STAGE_IMAGE
		FOREIGN KEY (ESTABLISH_NO) REFERENCES MY_SCHEMA.STAGE_SUPPLIER (ESTABLISH_NO);	
