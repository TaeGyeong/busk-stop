...
CREATE TABLE STAGE_SUPPLIER (
	...
	CONSTRAINT STAGE_SUPPLIER_PK PRIMARY KEY (ESTABLISH_NO,OPERATOR_USER_ID),
	CONSTRAINT FK_USERS_TO_STAGE_SUPPLIER FOREIGN KEY (OPERATOR_USER_ID) REFERENCES USERS(USER_ID)
);
...
CREATE TABLE STAGE_REVIEW (
	STAGE_NO NUMBER(10), /* 공연장 번호 */
	STAGE_REVIEW_USER_ID VARCHAR2(50), /* 사용자아이디 */
	STAR_SCORE NUMBER(1) NOT NULL, /* 별점 */
	STAGE_COMMENT VARCHAR2(3000) NOT NULL, /* 댓글내용 */
	
	CONSTRAINT PK_STAGE_REVIEW PRIMARY KEY (STAGE_NO, STAGE_REVIEW_USER_ID),
	CONSTRAINT FK_STAGE_TO_STAGE_REVIEW FOREIGN KEY (STAGE_NO) REFERENCES STAGE(STAGE_NO),
	CONSTRAINT FK_USERS_TO_STAGE_REVIEW FOREIGN KEY (STAGE_REVIEW_USER_ID) REFERENCES USERS(USER_ID)
);
/*------------------------------------------------------------------------------------*/
...
CREATE TABLE PERFORMANCE (
	...
	CONSTRAINT FK_USERS_TO_PERFORMANCE FOREIGN KEY (PERFORMANCE_USER_ID) REFERENCES USERS (USER_ID),
	CONSTRAINT FK_STAGE_TO_PERFORMANCE FOREIGN KEY (STAGE_NO) REFERENCES STAGE (STAGE_NO)
);
/*------------------------------------------------------------------------------------*/
...
CREATE TABLE PERFORMANCE_COMMENT (
	...
	CONSTRAINT FK_PERFORMANCE_TO_P_COMMENT FOREIGN KEY (PERFORMANCE_NO) REFERENCES PERFORMANCE (PERFORMANCE_NO),
	CONSTRAINT FK_USERS_TO_P_COMMENT FOREIGN KEY (PERFORMANCE_COMMENT_USER_ID) REFERENCES USERS (USER_ID)
);
...
CREATE TABLE PERFORMANCE_LIKE (
	...
	CONSTRAINT FK_PERFORMANCE_TO_P_LIKE FOREIGN KEY (PERFORMANCE_LIKE_NO)  REFERENCES PERFORMANCE (PERFORMANCE_NO),
...
CREATE TABLE VIDEO_COMMENT (
	...
	CONSTRAINT PK_VIDEO_COMMENT PRIMARY KEY (VIDEO_ID,USER_ID),
	CONSTRAINT FK_VIDEO_TO_VIDEO_COMMENT FOREIGN KEY (VIDEO_ID) REFERENCES VIDEO (VIDEO_ID),
	CONSTRAINT FK_USERS_TO_VIDEO_COMMENT FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID)
);
...
CREATE TABLE VIDEO_LIKE (
	...
	CONSTRAINT FK_VIDEO_TO_VIDEO_LIKE FOREIGN KEY (VIDEO_LIKE_NO) REFERENCES VIDEO (VIDEO_ID),
...
CREATE TABLE USED_COMMENT (
	...
	CONSTRAINT PK_USED_COMMENT PRIMARY KEY (USED_GOODS_NO,PURCHARSE_ID),
	CONSTRAINT FK_USED_GOODS_TO_USED_COMMENT FOREIGN KEY (USED_GOODS_NO) REFERENCES USED_GOODS (USED_GOODS_NO),
	CONSTRAINT FK_USERS_TO_USED_COMMENT FOREIGN KEY (PURCHARSE_ID) REFERENCES USERS (USER_ID) 
);
...
CREATE TABLE APPLICANT (
	...
	CONSTRAINT PK_APPLICANT PRIMARY KEY (EMPLOY_NO),
...
CREATE TABLE STUDENTS (
	...
	CONSTRAINT PK_STUDENTS PRIMARY KEY (TEACHERS_NO),
