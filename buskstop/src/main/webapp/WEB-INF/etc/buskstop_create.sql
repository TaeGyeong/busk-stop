...
CREATE TABLE USED_COMMENT (
	USED_COMMENT_NO NUMBER(10) NOT NULL, /* 중고상품 댓글 번호 */
	USED_GOODS_NO NUMBER(10) NOT NULL, /* 중고상품 번호 */
	USED_COMMENT_USER_ID VARCHAR2(50) NOT NULL, /* 구매했던자 아이디 */
	USED_COMMENT VARCHAR2(3000), /* 글내용 */
	
	CONSTRAINT PK_USED_COMMENT PRIMARY KEY (USED_GOODS_NO,USED_COMMENT_NO),
	CONSTRAINT FK_USED_GOODS_TO_USED_COMMENT FOREIGN KEY (USED_GOODS_NO) REFERENCES USED_GOODS (USED_GOODS_NO),
	CONSTRAINT FK_USERS_TO_USED_COMMENT FOREIGN KEY (USED_COMMENT_USER_ID) REFERENCES USERS (USER_ID) 
);
