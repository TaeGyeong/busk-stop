...
CREATE TABLE PREMIUM_STAGE (
	...
	CONSTRAINT PREMIUM_STAGE_PK PRIMARY KEY (ESTABLISH_NO,OPERATOR_USER_ID,OPERATOR_NO),
...
CREATE TABLE PREMIUM_STAGE_RESERVATION (
	RESERVATION_NO NUMBER(10) NOT NULL, /* 옵션번호 */
	...
	CONSTRAINT FK_PREMIUM_STAGE_TO_PREMIUM_STAGE_RESERVATION
...
/*------------------------------------------------------------------------------------*/
	...
	/* 프리미엄 공급장 예약 시간코드 */
CREATE TABLE PREMIUM_STAGE_RESERVATION_TIME (
	TIME_CODE NUMBER(2) NOT NULL, /* 시간코드 */
	STAGE_RENTAL_DATE DATE NOT NULL, /* 대관가능 날짜 */
	RESERVATION_NO NUMBER(10) /* 옵션번호 */
	...
	CONSTRAINT FK_PREMIUM_STAGE_RESERVATION_TO_PREMIUM_STAGE_RESERVATION_TIME
		FOREIGN KEY (RESERVATION_NO)	REFERENCES PREMIUM_STAGE_RESERVATION (RESERVATION_NO);	
);
...
/*------------------------------------------------------------------------------------*/	
	...
	CONSTRAINT FK_PREMIUM_STAGE_TO_PREMIUM_STAGE_IMAGE
