...
CREATE TABLE PREMIUM_STAGE_RESERVATION (
	...
	USER_ID VARCHAR2(50) , /* 사용자아이디 */
	ESTABLISH_NO NUMBER(10) NOT NULL, /* 사업장 번호 */
	RESERVATION_REG_TIME DATE NOT NULL,
...
CREATE TABLE PREMIUM_STAGE_RESERVATION_TIME (
	...
	CONSTRAINT PK_PREMIUM_RESERVE_TIME
		PRIMARY KEY (TIME_CODE, STAGE_RENTAL_DATE),
		
	CONSTRAINT FK_RESERVATION_TO_NO
...
CREATE TABLE STAGE (
	...
	STAGE_START_TIME TIME NOT NULL,
	STAGE_END_TIME TIME NOT NULL,
