...
/* 팔로우 */
CREATE TABLE FOLLOW (
	FOLLOWING_ID VARCHAR2(50) PRIMARY KEY, /* 사용자아이디 */
	FOLLOWER_ID VARCHAR2(50) PRIMARY KEY, /* 팔로잉당한사람 */
	CONSTRAINT FK_USER_ID FOREIGN KEY (FOLLOWING_ID) REFERENCES USERS (USER_ID),
	CONSTRAINT FK_USER_ID_FOLLOWER FOREIGN KEY (FOLLOWER_ID) REFERENCES USERS (USER_ID) 
);
