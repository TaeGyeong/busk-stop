...
public class PerformanceController {
	...
	public ModelAndView selectArtistPerformance(@RequestParam(required=false) String category, @RequestParam(required=false) String search,@RequestParam(required=false) String sDate, @RequestParam(required=false) String eDate) throws ParseException ,IOException, ServletException{
		List<Performance> list = null;
		Map<String, Object> map = null;
		int page = 1;
